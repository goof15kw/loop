...
{ 
  ...
  Serial.print(errEau);
  Serial.print("] ");
  Serial.print(((1.0*errEau)/(1.0*nbLecture))*100.0);
  Serial.print("% \nExt [");
  ...
  Serial.print(errExt);
  Serial.print("] ");
  Serial.print(((1.0*errExt)/(1.0*nbLecture))*100.0);
  Serial.print("% ");
